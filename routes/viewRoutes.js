...
viewRouter
    .route('/lists')
    .get(viewController.getUserLists, viewController.getListsPage);
viewRouter
    .route('/lists/create')
    .get(viewController.getCreateListPage)
    .post(listController.createList);
viewRouter
    .route('/lists/:id')
    .get(viewController.getList, viewController.getListPage)
    .post(viewController.getList, listController.handleViewPost);
viewRouter
    .route('/profile')
    .get(viewController.getProfilePage)
    .post(fileUpload.single('profilePicture'), userController.updateUserData);
...
viewRouter
    .route('/resetPassword')
    .get(authController.includeResetToken, viewController.getResetPasswordPage)

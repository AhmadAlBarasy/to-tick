...
listRouter
    .route('/lists/create')
    .post(listController.createList, listController.sendAPIResponse);
listRouter
    .route('/lists/:id/tasks/')
    .post(listController.createTask, listController.sendAPIResponse);
listRouter
...
listRouter
    .route('/lists')
    .get(listController.getAllLists, listController.sendAPIResponse);
